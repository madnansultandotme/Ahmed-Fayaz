...
import profile from "@/assets/ahmed-fayaz.jpg";
            ...
            <div className="text-left">
              ...
              <div className="flex space-x-4 mt-8">
                ...
                <a href="https://contra.com/ahmed_fayaz_n6f1ycoi" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://www.upwork.com/freelancers/~0180f83792703b7a92?mp_source=share" target="_blank" rel="noopener noreferrer"
                     className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-colors backdrop-blur-sm">
                    <UpworkLogo />
                  </a>
              </div>
            </div>
